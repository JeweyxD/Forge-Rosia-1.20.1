...
public class AutoQuernRecipeCategory implements IRecipeCategory<AutoQuernRecipe> {
    ...
    public static final RecipeType<AutoQuernRecipe> AUTO_QUERN_TYPE =
            new RecipeType<>(UID, AutoQuernRecipe.class);
    ...
    public AutoQuernRecipeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlocks.AUTO_QUERN.get()));
    ...
    @Override
    public void draw(AutoQuernRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
    ...
    @Override
    public RecipeType<AutoQuernRecipe> getRecipeType() {
        return AUTO_QUERN_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("block.rosia.auto_quern");
    }
