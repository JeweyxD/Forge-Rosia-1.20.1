...
public class ScrapingMachineRecipeCategory implements IRecipeCategory<ScrapingMachineRecipe> {
    ...
    public static final RecipeType<ScrapingMachineRecipe> SCRAPING_MACHINE_TYPE =
            new RecipeType<>(UID, ScrapingMachineRecipe.class);
    ...
    public ScrapingMachineRecipeCategory(IGuiHelper helper) {
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ModBlocks.SCRAPING_MACHINE.get()));
    ...
    @Override
    public void draw(ScrapingMachineRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics stack, double mouseX, double mouseY) {
        arrow.draw(stack, 48, 6);
        arrowAnimated.draw(stack, 48, 6);
    }

    @Override
    public RecipeType<ScrapingMachineRecipe> getRecipeType() {
        return SCRAPING_MACHINE_TYPE;
    }

    @Override
    public Component getTitle() {
        return Component.translatable("block.rosia.scraping_machine");
    }
