...
import com.jewey.rosia.common.blocks.block.rolling_machine;
...
public class RollingMachineBlockEntity extends TickableInventoryBlockEntity<ItemStackHandler> implements MenuProvider
{
    ...
    private static final Component NAME = Component.translatable(MOD_ID + ".block_entity.rolling_machine");
