...
public class MagnetizerScreen extends BlockEntityScreen<MagnetizerBlockEntity, MagnetizerContainer>
{
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Rosia.MOD_ID, "textures/gui/canning_press.png");

    public MagnetizerScreen(MagnetizerContainer container, Inventory playerInventory, Component name)
    {
