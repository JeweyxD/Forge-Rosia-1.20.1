...
import com.jewey.rosia.screen.button.mechanical_generator.MechanicalGeneratorEnergyOutputToggle;
...
public class MechanicalGeneratorScreen extends BlockEntityScreen<MechanicalGeneratorBlockEntity, MechanicalGeneratorContainer>
{
    public static final ResourceLocation TEXTURE =
            new ResourceLocation(Rosia.MOD_ID, "textures/gui/nickel_iron_battery_gui.png");

    public MechanicalGeneratorScreen(MechanicalGeneratorContainer pMenu, Inventory pPlayerInventory, Component pTitle) {
    ...
    protected void init() {
        super.init();
        addRenderableWidget(new MechanicalGeneratorEnergyOutputToggle(blockEntity, getGuiLeft(), getGuiTop()));
    }
