...
import com.jewey.rosia.screen.button.nickel_iron_battery.NickelIronBatteryEnergyOutputToggle;
...
public class NickelIronBatteryScreen extends BlockEntityScreen<NickelIronBatteryBlockEntity, NickelIronBatteryContainer>
{
    ...
    protected void init() {
        super.init();
        addRenderableWidget(new NickelIronBatteryEnergyOutputToggle(blockEntity, getGuiLeft(), getGuiTop()));
    }
